...
```{r load-data}
pest_data <- readRDS('data/building_data_20180803_alt.RDS')
str(pest_data)
```
...
```{r}
print(fitted_model_NB_hier_mos, pars = c('zeta','alpha','sigma_kappa','sigma_mu','phi','rho','beta','alpha','gamma'))
```
...
costs <- costs + (1:N_traps < 5)*(6*20) + (1:N_traps >= 5 & 1:N_traps < 10)*(6*(20 + 30)) + (1:N_traps >= 10 & 1:N_traps < 15)*(6*(20 + 2 * 30)) +  + (1:N_traps >= 15) * (6*(20 + 3 * 30))
```
